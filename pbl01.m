...
fc = 15; % Frequência de corte em Hz
ordem = 2; % Ordem do filtro
[b, a] = butter(ordem, fc/(Fs/2)); % Projeta o filtro
yt_filtr = filter(b, a, yt); % Aplica o filtro ao sinal
...
##% figure('CloseRequestFcn', @(src, event) close_all_figures()); figure
