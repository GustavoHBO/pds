...
amplitudes = [1, 0.7, 0.5]; % Amplitudes of signals
...
Fs = 1000 * max_frequency; % Sampling frequency
...
for i = 1:num_signals
    ...
    fft_signal = fftshift(fft(signals_real(i, :)));
    ...
    fft_signal = fftshift(fft(signals(i, :)));
